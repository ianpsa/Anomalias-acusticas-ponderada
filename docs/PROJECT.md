...
O ESP32 com INMP441 captura áudio continuamente e executa tarefas FreeRTOS de captura, extração de características e detecção. O computador local fornece controles e áudio na primeira fase. A conversa é atendida por um **servidor LM Studio já existente em outro computador**. Este repositório não instala, implementa ou hospeda esse servidor de IA.
